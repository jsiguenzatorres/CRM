...
>
> This repository is **jsiguenzatorres/CRM**, a personal fork of [twentyhq/twenty](https://github.com/twentyhq/twenty),
> imported on **2026-08-24** from upstream commit
> [`9e4717278c29efa3ba0c147f6acf0d68e99a625`](https://github.com/twentyhq/twenty/commit/9e4717278c29efa3ba0c147f6acf0d68e99a625),
> to be reviewed, self-hosted and customized as my own CRM.
>
> It is **not affiliated with or endorsed by Twenty.com, PBC**. See [`FORK_NOTES.md`](./FORK_NOTES.md) for what
> changed, licensing implications (AGPLv3 + Enterprise-gated modules), and setup/next steps. The original project
> and its trademarks belong to their respective owners — see `.github/TRADEMARK.md`.
