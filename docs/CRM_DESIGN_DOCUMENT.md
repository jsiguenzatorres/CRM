...
| **P2 — Fase 1 lista, Fase 2 en diseño** (acotado) | Click-to-call e integración de proveedores VoIP | EspoCRM | Confirmado: no había ninguna integración de telefonía en el repo. Fase 1 (link `tel:`, sin proveedor) implementada. Proveedor elegido para la Fase 2: **Twilio Voice** (sin costo por asiento, SDK headless) — arquitectura de las 3 rutas + dialer embebido diseñada en [`docs/CLICK_TO_CALL_DESIGN.md`](./CLICK_TO_CALL_DESIGN.md), pendiente de implementar contra un servidor real |
